...
export default function ShortFormulasPage() {
  ...
  const formulas = useMemo(() => (allFormulas[tradingMode] || []).filter(f => f.positionType !== 'Long'), [allFormulas, tradingMode]);
  ...
  return (
    <MainLayout>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-headline font-bold">My Short Formulas</h2>
